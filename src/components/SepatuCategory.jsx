  ...
  return (
    <section className="pt-0 pb-20 px-20 overflow-hidden m-0 bg-gray-100">
      <div className="flex flex-wrap justify-between">
        <h2 className="text-2xl font-bold mb-6 text-black">Sepatu</h2>
      ...
      <div className="relative">
        ...
        >
          <ProductItem
            discount="25%"
            imgSrc="img/pro-sepatu.jpg"
            title="Converse Run Star Hike Shoes"
            rating="4.5"
            price="Rp 1.099.000,00"
          />
          <ProductItem
            discount="25%"
            imgSrc="img/pro-sepatu.jpg"
